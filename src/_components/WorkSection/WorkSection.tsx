        ...
        <ReactLenis root>
            <section id="work" className="w-full bg-white">
                <div className="container-fluid grid grid-cols-1 pt-[80px] md:grid-cols-2 md:pt-[135px]">
                    ...
                    {/* LEFT SIDE */}
                    <div className="relative grid h-auto place-content-start md:sticky md:top-0 md:h-screen">
                    ...
                    <div className="grid gap-10">
                        ...
                        {works.map((work, index) => (
                            <figure
                                key={index}
                                className="sticky top-0 grid  cursor-none place-content-start"
                                data-cursor="white"
                            ...
                            >
                                <img
                                    ...
                                    className={`w-full object-cover align-bottom transition-all duration-300 ${work.rounded ? 'rounded-md' : ''
                                        }`}
                                />
